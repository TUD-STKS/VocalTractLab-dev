...
shift1 = DefineNumber[radius1*0.5, Name "shift1"];
shift2 = DefineNumber[radius2*0.5, Name "shift2"];

Point(1) = {0., 0., 0.+shift1, ms };
Point(2) = {0., radius1, 0.+shift1, ms};
Point(3) = {0., 0., radius1+shift1, ms};
Point(4) = {0., -radius1, 0.+shift1, ms};
Point(5) = {0., 0., -radius1+shift1, ms};
Point(6) = {length, 0., 0.+shift2, ms};
Point(7) = {length, radius2, 0.+shift2, ms};
Point(8) = {length, 0., radius2+shift2, ms};
Point(9) = {length, -radius2, 0.+shift2, ms};
Point(10) = {length, 0., -radius2+shift2, ms};
